...
var JWT_SECRET = process.env.JWT_SECRET || 'your-secret-key'; // Store this in your .env file
// Hash password
...
var generateToken = function (userId, role) {
    return jsonwebtoken_1.default.sign({ userId: userId, role: role }, JWT_SECRET, { expiresIn: '1h' });
};
